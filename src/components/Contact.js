            ...
            <div id='contact' className='secition'>
                <ul>
                    <li>
                        ...
                        <p> Github: <a href={data.github.link}>{data.github.name}</a></p>
                    </li>
                    <li>
                        <div className='contact-icon'>
                        ...
                        <p> LinkedIn: <a href={data.linkedin.link}>{data.linkedin.name}</a></p>
                    </li>
                    <li>
                        <div className='contact-icon'>
                        ...
                        <p> Telegram: <a href={data.telegram.link}>{data.telegram.name}</a></p>
                    </li>
                    <li>
                        <div className='contact-icon'>
                        ...
                        <p> Email: <a href={data.email.link}>{data.email.name}</a></p>
                    </li>
                    <li>
                        <div className='contact-icon'>
